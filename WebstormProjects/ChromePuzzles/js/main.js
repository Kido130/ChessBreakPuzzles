...
<<<<<<< HEAD
                    // Skip any header lines (comments and const declaration)
=======
                    // Skip any header lines (first few lines might be comments)
>>>>>>> 1b30f1b6c667dbf3ca89e7f8b8a544c172b04813
...
<<<<<<< HEAD
                        // Clean up the line (remove quotes, brackets, commas at end)
=======
...
<<<<<<< HEAD
                        // Check if line has the required format (at least PuzzleID,FEN,Moves,Rating)
                        const parts = cleanLine.split(',');
                        if (parts.length >= 4) {
                            window.puzzlesCache.push(cleanLine);
                        } else {
                            console.warn('Skipping invalid puzzle line:', cleanLine);
=======
...
<<<<<<< HEAD
            const popularity = parseFloat(parts[5]);
...
<<<<<<< HEAD
            // Check if the puzzle meets criteria:
            // 1. Rating is within range of user's rating
            // 2. Has high popularity (> 95) and sufficient plays (> 5000)
            if (Math.abs(puzzleRating - userRating) <= RATING_RANGE && 
                popularity >= 95.0 && nbPlays >= 5000) {
                console.log(`Found suitable puzzle: ${puzzleId}, rating: ${puzzleRating}, popularity: ${popularity}, plays: ${nbPlays}`);
=======
...
<<<<<<< HEAD
            const ratingDeviation = puzzleData[4];
            const popularity = puzzleData[5];
            const nbPlays = puzzleData[6];
=======
>>>>>>> 1b30f1b6c667dbf3ca89e7f8b8a544c172b04813
